...
export default function AudioPlayerSonno({ tracks }) {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div>{<ScenaMeditazione modelPath="./meditazioneSonno.glb" />}</div>{" "}
        ...
        <div className="p-6 bg-[#c7c7c7] bg-opacity-80 backdrop-blur-md rounded-lg w-150 text-white">
          ...
          <div className="flex justify-center mb-6">
            <img
              ...
              alt="track"
              className="w-100 h-60 object-cover rounded-lg shadow-2xl hover:shadow-3xl transition-shadow duration-300 mt-10"
            />
          </div>
          ...
          <input
            ...
            className="w-full h-1 rounded-full mt-10 "
          />
